                ...
                <div class="flex">
                    @auth
                        ...
                        <a href="{{route('profile.edit')}}">
                          <img src="{{Auth::user()->user_image ? asset('storage/' . Auth::user()->user_image) : asset('storage/images/avatar.png')}}" alt="user_image" class="w-11 h-11 p-1 rounded-full border border-gray-900 dark:border-blue-600">
                        </a>   
              @else
