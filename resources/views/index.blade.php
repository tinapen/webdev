    ...
    <body>
        <nav  class="fixed inset-x-0 top-0 z-30 border-gray-200 dark:bg-slate-900">
            ...
            <div class="flex items-center">
                ...
                <h1 class="ms-5 font-sans antialiased font-bold text-gray-900 dark:text-white">WEBDEV</h1>
            </div>
                @if (Route::has('login'))
                <div class="flex">
                    @auth
                        ...
                        <a href="{{route('profile.edit')}}">
                          ...
                          <img src="{{asset('storage/' . Auth::user()->user_image)}}" alt="user_image" class="w-11 h-11 p-1 rounded-full border border-gray-900 dark:border-blue-600">
                          @else
                          <x-avatar />
                          @endif
                        </a>  
                    @else
                    <a href="{{ route('login') }}" class="flex items-centerfont-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 me-1">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 9V5.25A2.25 2.25 0 0 1 10.5 3h6a2.25 2.25 0 0 1 2.25 2.25v13.5A2.25 2.25 0 0 1 16.5 21h-6a2.25 2.25 0 0 1-2.25-2.25V15M12 9l3 3m0 0-3 3m3-3H2.25" />
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="flex items-center ms-2 ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 me-1 ">
        ...
        <div
        class="relative isolate overflow-hidden bg-gray-50 dark:bg-gray-900 h-[100vh]"
      >
        <svg
        ...
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
              ...
              <p class="mt-6 text-lg leading-8 text-gray-900 dark:text-white">
                Read and post about latest trends <br> in technologies and web
                development!
              </p>
            </div>
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                ...
                <ul class="ext-gray-900 dark:text-white font-medium">
                  <li class="mb-4">
          ...
          <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <div class="flex mt-4 sm:justify-center sm:mt-0">
              <a
                ...
                class="text-gray-500 dark:text-gray-50 hover:text-gray-900 dark:hover:text-gray-900"
                target="_blank"
              >
              ...
              <a
                ...
                class="text-gray-500 dark:text-gray-50 hover:text-gray-900 dark:hover:text-gray-900 ms-5"
                target="_blank"
              >
              <svg class="w-[30px] h-[30px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
