...
<div class="p-4 sm:ml-64 dark:bg-gray-900 min-h-[100vh]">
  <div class="p-4 mt-12">
    <x-flash-message />
    <form action="/edit-post/{{$post->id}}" method="POST"  enctype="multipart/form-data" class="mx-64 py-14">
      @csrf
      @method('PUT')
      <div class="flex">
      ...
      <div class="my-4">
        ...
        <input name="post_image" id="post_image" type="file" value="{{$post->post_image}}" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help">
