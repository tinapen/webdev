    ...
    <div class="grid grid-cols-4 gap-4 mb-4">
      ...
      <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="px-4 my-1">
          ...
          @endphp
          @foreach($tags as $tag)
          <a href="/your-posts/?tag={{$tag}}" id='tags' class="inline-flex p-2 w-fit rounded-full border border-gray-200 dark:border-gray-700 text-gray-500 dark:text-white text-xs">
            {{$tag}}
            </a>
          @endforeach
          </div>
